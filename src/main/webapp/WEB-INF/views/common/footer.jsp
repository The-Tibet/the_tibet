...
<body>
   <footer>
        ...
        <ul> PRODUCT
            <li>
                <a href="${contextPath}/outer.do?p=1">OUTER</a>
            </li>
            <li>
                <a href="${contextPath}/top.do?p=1">TOP</a>
            </li>
            <li>
                <a href="${contextPath}/pants.do?p=1">PANTS</a>
            </li>
            <li>
                <a href="${contextPath}/bag.do?p=1">BAG</a>
            </li>
            <li>
                <a href="${contextPath}/acc.do?p=1">ACC</a>
            </li>	
        </ul>
