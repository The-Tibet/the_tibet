...
<body>
	<section>
		...
		<div>
			<ul class="sort">
				<li class="UnSelectMenu"><a href="${contextPath}/outer-2.do?p=2">low price</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/outer-2.do?p=3">high price</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/outer-2.do?p=4">name</a></li>
				<li class="UnSelectMenu"><a href="${contextPath}/outer-2.do?p=1">new arrival</a></li>
			</ul>
		</div>
