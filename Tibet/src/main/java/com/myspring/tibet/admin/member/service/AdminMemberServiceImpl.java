...
public class AdminMemberServiceImpl implements AdminMemberService {
	...
	public int adminMemberUpdate(MemberVO vo) throws Exception {
		return adminMemberDAO.adminMemberUpdate(vo); 

	}
	// 회원수정 폼
	@Override 
	public MemberVO adminMemberUpdateForm(String user_id) throws Exception {
		return adminMemberDAO.adminMemberUpdateForm(user_id);
}
